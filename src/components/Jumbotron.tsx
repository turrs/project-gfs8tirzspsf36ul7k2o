...
const Jumbotron: React.FC = () => (
  <div className="bg-[#9AE462] rounded-2xl p-8 shadow-lg flex flex-col justify-center items-start h-full">
    <h1 className="text-3xl font-bold text-[#1A1A25] mb-4">Welcome to Jup-suck!</h1>
    <p className="text-lg text-[#1A1A25] mb-6">
    "A simple DEX for Solana—because swapping shouldn't require a DeFi degree."
    </p>
    <ul className="list-disc pl-5 text-[#1A1A25]">
    I built this DEX because Jupiter, while powerful, is too complex for beginners.
